...
export function ProfessorSignIn() {
  ...
  const handleSignIn = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch(`${API_CONFIG.BASE_URL}${API_CONFIG.ENDPOINTS.PROFESSORS.LOGIN}`, {
        method: "POST",
        headers: {
      ...
      if (response.ok) {
        ...
        const professorResponse = await fetch(
          `${API_CONFIG.BASE_URL}${API_CONFIG.ENDPOINTS.PROFESSORS.GET_BY_ID}/${professorId}`
        );
