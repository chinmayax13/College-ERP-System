...
export function AdminSignUp() {
  ...
  const handleSignUp = async (e) => {
    ...
    if (!name || !department || !username || !password || !email || !phone || !adminId) {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:8787/api/admin/auth/signup",
        formData,
        {
          headers: {
      ...
      setSuccess("Admin registered successfully! Redirecting to login page...");
      setError("");
      ...
      let errorMessage = "Error uploading admin data. Please try again.";
      ...
      <Card className="w-full max-w-lg p-6">
        ...
        <form className="mt-8" onSubmit={handleSignUp}>
          ...
          >
            ...
            <Link to="/auth/admin/sign-in" className="text-gray-900 ml-1">
              Sign In
            </Link>
          </Typography>
        </form>
