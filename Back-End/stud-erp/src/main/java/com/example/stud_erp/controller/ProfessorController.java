...
public class ProfessorController {
    ...
    // public ResponseEntity<Professor> createProfessor(@RequestBody Professor
    // professor) {
    ...
    public ResponseEntity<String> createProfessor(@RequestParam("file") MultipartFile multipartFile,
        ...
        try {
            ...
            return ResponseEntity.status(HttpStatus.CONFLICT)
                    .body("A professor with the same ID, Username, or Email already exists.");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Professor> updateProfessorProfile(@PathVariable Long id,
            @RequestBody Professor updatedProfessor) {
        try {
            Professor professor = professorService.updateProfessorProfile(id, updatedProfessor);
